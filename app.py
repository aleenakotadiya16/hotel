...
with col4:
    ...
    st.info(
        f"""
        - In **{selected_segment}**, different customer tiers generate varying revenue.
        - Useful to design targeted loyalty programs and promotions.
        """
    )
...
st.success(
    "Insight: Customers with more loyalty points tend to generate higher average revenue. "
    "Consider exclusive perks for top tiers."
)
